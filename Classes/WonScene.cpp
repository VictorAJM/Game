...
Scene* WonScene::createScene()
{
    return WonScene::create();
}
...
bool WonScene::init()
{
    ...
    auto* blue_pill = MenuItemImage::create("bluePill1.png",
                                            "bluePill2.png",
                                            CC_CALLBACK_1(WonScene::BluePill, this));
    ...
    auto* red_pill = MenuItemImage::create("redPill1.png",
                                            "redPill2.png",
                                            CC_CALLBACK_1(WonScene::RedPill, this));
...
void WonScene::BluePill(Ref* pSender) {
    Director::getInstance()->replaceScene(GameMenu::createScene());
}



void WonScene::RedPill(Ref* pSender)
{
